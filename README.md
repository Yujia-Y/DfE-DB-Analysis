...
_**plot_paradigm_distribution**: This code is used to create figure4.

_**plot_feature_distribution_grouped_horizon**: This code is used to create figure5.

_**feature_MPS_plot**: This code is used to create figure S1